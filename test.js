...
// console.log(students.reduce((previousValue, currentValue) => previousValue + currentValue.age, 0));

// console.log(students.reduce((previousValue, currentValue) => {
...
const [first, second, oso, ...rest] = languages;
